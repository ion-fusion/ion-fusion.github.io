...
# Use Docker official images for Debian; see https://hub.docker.com/_/debian
FROM debian:bookworm-slim@sha256:90522eeb7e5923ee2b871c639059537b30521272f10ca86fdbbbb2b75a8c40cd

# Use Debian snapshots; see https://snapshot.debian.org/
ARG DEBIAN_SNAPSHOT="20250523T000000Z"
...
# such a volume mount would also remove the installed gems.
...
RUN --network=default bundlew jekyll-build

# Default command is to run the jekyll development server:
CMD ["bundlew", "jekyll-serve", "--livereload"]
